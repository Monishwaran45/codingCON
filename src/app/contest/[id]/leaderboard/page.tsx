...
export default function LeaderboardPage() {
  ...
  return (
    <AuthGuard
      fallbackTitle="Sign In to View Leaderboard"
      fallbackMessage="Please sign in with your student or faculty account to view live standings, solve breakdown, and rankings."
    >
