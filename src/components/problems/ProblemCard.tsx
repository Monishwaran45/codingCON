...
export const ProblemCard: React.FC<ProblemCardProps> = ({ problem }) => {
  return (
    ...
    >
            ...
            <div
              className={cn(
                ...
                problem.isSolved
                  ...
                  : 'border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 text-zinc-400',
              )}
      ...
      {/* Footer Meta Row */}
      <div className="flex items-center justify-between border-t border-zinc-100 dark:border-zinc-900 pt-3 text-[0.7rem] text-zinc-500 font-jetbrains">
